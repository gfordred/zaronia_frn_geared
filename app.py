...
try:
    ...
    # Tabs - Streamlit manages tab state automatically
    # Note: st.tabs does not support programmatic tab selection
    # Users must manually click tabs to navigate
    tabs = st.tabs([
        "Market Data",
        "Curve Analysis", 
        "FRN Pricer & Risk",
            ...
            with portfolio_tabs[0]:
                ...
                with st.expander("ℹ️ Balance Sheet Calculation"):
                    ...
                    st.markdown(
                        ...
                        f"**Liabilities (R{liab_val:.1f}M):**\n" +
                        f"- Repo Outstanding = R{liab_val:.1f}M\n" +
                        "- Borrowed funds used to buy FRNs\n" +
                        "- Must be repaid with interest\n\n" +
                        f"**Equity / NAV (R{equity_val:.1f}M):**\n" +
                        "- Net Asset Value = Assets - Liabilities\n" +
                        f"- NAV = R{assets_val:.1f}M - R{liab_val:.1f}M = R{equity_val:.1f}M\n" +
                        "- This is what you actually own\n\n" +
                        f"**Gearing ({gearing:.2f}x):**\n" +
                        "- Formula: Repo Outstanding / Seed Capital\n" +
                        f"- Gearing = R{liab_val:.0f}M / R{seed_val:.0f}M = {gearing:.2f}x\n" +
                        f"- For every R1 of equity, we borrowed R{gearing:.1f}\n\n" +
                        "**Verification:**\n" +
                        f"- Assets = R{assets_val:.1f}M ✓\n" +
                        f"- Liabilities = R{liab_val:.1f}M ✓\n" +
